...
{.passC: fmt" -I{currentDir} -DNANOVG_GL3_IMPLEMENTATION".}
{.compile: "nanovg.c".}
{.compile: "glad.c".}

{.emit: fmt"""
#include "{currentDir}/glad/glad.h"
#include "{currentDir}/nanovg.h"
#include "{currentDir}/nanovg_gl.h"
#include "{currentDir}/nanovg_gl_utils.h"
""".}
