...
proc endFrame*(gfx: Gfx) =
  ...
  glViewport(0.GLint, 0.GLint, gfx.sizePixels.x.GLsizei, gfx.sizePixels.y.GLsizei)
  glScissor(0.GLint, 0.GLint, gfx.sizePixels.x.GLsizei, gfx.sizePixels.y.GLsizei)
