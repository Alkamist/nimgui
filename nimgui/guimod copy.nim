...
func beginEndContainer*(gui: Gui, T: typedesc): T {.discardable.} =
  gui.isEndDrawList = true
  let container = T(gui.containerStack[^1])
  container
